...
describe('treeDeep() 测试', () => {
  const tree = [
    {
      id: 1,
      list: [{ id: 11 }, { id: 12, list: [{ id: 121 }, { id: 122 }] }],
    },
    { id: 2 },
  ];
...
describe('buildTree() 测试', () => {
  test('buildTree() 最简用例', () => {
    expect(
    ...
    ).toEqual([
      {
        ...
        pid: 0,
        name: 'Item1',
        children: [{ id: 2, pid: 1, name: 'Item2', children: [] }],
      },
    ]);
  });
  ...
  test('buildTree() 自定义 pid,id', () => {
    expect(
    ...
    ).toEqual([
      {
        ...
        parentId: 0,
        title: 'Menu1',
        children: [{ menuId: 2, parentId: 1, title: 'Menu1-1', children: [] }],
      },
    ]);
  });
    ...
    const res = buildTree(
      [
        ...
        { menuId: 11, parentId: 1, title: 'Menu1-1' },
        {
          ...
          parentId: 0,
          title: 'Menu1',
          children: [{ menuId: 12, parentId: 1, title: 'Menu1-2', children: [] }],
        },
      ],
      'menuId',
      'parentId',
  ...
  test('buildTree() 只有子分支', () => {
    const res = buildTree(
      [
        { menuId: 111, parentId: 11, title: 'Menu1-1-1' },
        { menuId: 11, parentId: 1, title: 'Menu1-1' },
        { menuId: 22, parentId: 2, title: 'Menu2-2' },
        { menuId: 222, parentId: 22, title: 'Menu2-2-2' },
      ],
      'menuId',
      'parentId',
    );
